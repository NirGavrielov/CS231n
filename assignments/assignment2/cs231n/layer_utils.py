...
def concat_layer_forward(x, w, b, gamma=None, beta=None, bn_param=None, dropout_param=None):
    """does forward pass of affine - norm - relu - dropout where bn and dropout are optional"""
    out, fc_cache = affine_forward(x, w, b)
    bn_cache, ln_cache, dropout_cache = None, None, None
    ...
    return out, (fc_cache, bn_cache, ln_cache, relu_cache, dropout_cache)


def concat_layer_backward(dout, cache):
    """does backward pass of affine - norm - relu - dropout where bn and dropout are optional"""
